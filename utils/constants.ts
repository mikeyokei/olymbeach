...
export interface ShapeConfig {
  // Original path bounds (for clip path scaling)
  pathWidth: number;
  pathHeight: number;
  // Padded viewBox for stroke rendering
  viewBoxMinX: number;
  viewBoxMinY: number;
  viewBoxWidth: number;
...
// Added padding (20 units each side) to prevent stroke clipping
